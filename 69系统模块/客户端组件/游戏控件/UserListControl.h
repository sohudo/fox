...
//默认颜色
#define COLOR_SELECT_TX				RGB(255,255,255)					//字体颜色
#define COLOR_SELECT_BK				RGB(59,145,122)						//鼠标选定用户背景浅绿
#define COLOR_NORMAL_TX				RGB(0,0,0)							//字体颜色
#define COLOR_NORMAL_BK				RGB(177,216,255)					//背景颜色

//默认颜色
#define COLOR_MYSELF_TX				RGB(255,255,255)					//字体颜色
#define COLOR_MYSELF_BK				RGB(82,113,159)					    //背景颜色
#define COLOR_MASTER_TX				RGB(255,255,255)					//字体颜色
#define COLOR_MASTER_BK				RGB(82,113,159)						//背景颜色
#define COLOR_MEMBER_TX				RGB(218,45,3)						//字体颜色
#define COLOR_MEMBER_BK				RGB(177,216,255)					//会员背景色修改
...
public:
	...
	//设置列表
	bool SetColumnDescribe(tagColumnItem ColumnItem[], WORD wColumnCount,int iFilterIndex);
	//消息映射
protected:
	//销毁消息
	VOID OnNcDestroy();
