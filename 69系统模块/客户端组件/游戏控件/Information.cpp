...
#define SMB_BUTTON_BOTTOM			20									//按钮偏移
#define SMB_BUTTON_SPACE			20									//按钮间隔
#define SMB_BUTTON_WIDTH			70									//按钮偏移
#define SMB_BUTTON_HEIGHT			31									//按钮偏移
...
VOID CInformation::CreateBoxButton()
{
	...
	for (UINT i=0;i<m_nBtCount;i++)  m_btButton[i].Create(TEXT(""),WS_CHILD,rcButton,this,uButtonID[i]);;//m_btButton[i].Create(pszString[i],WS_CHILD,rcButton,this,uButtonID[i]);

	m_btButton[0].SetButtonImage(IDB_BT_OK,GetModuleHandle(SHARE_CONTROL_DLL_NAME),false,false);
	m_btButton[1].SetButtonImage(IDB_BT_CANCEL,GetModuleHandle(SHARE_CONTROL_DLL_NAME),false,false);
...
VOID CInformation::OnPaint()
{
	...
	//else if (uIconType==MB_ICONQUESTION) hIcon=LoadIcon(NULL,IDI_QUESTION);			//问号
	//else if (uIconType==MB_ICONEXCLAMATION) hIcon=LoadIcon(NULL,IDI_EXCLAMATION);	//叹号
	//else hIcon=LoadIcon(NULL,IDI_ASTERISK);	//星号
	//if (uIconType==MB_ICONHAND) hIcon=LoadIcon(GetModuleHandle(SHARE_CONTROL_DLL_NAME),MAKEINTRESOURCE(IDI_ICON1));
	//else if (uIconType==MB_ICONQUESTION) hIcon=LoadIcon(GetModuleHandle(SHARE_CONTROL_DLL_NAME),MAKEINTRESOURCE(IDI_ICON3));			//问号
	//else if (uIconType==MB_ICONEXCLAMATION) hIcon=LoadIcon(GetModuleHandle(SHARE_CONTROL_DLL_NAME),MAKEINTRESOURCE(IDI_ICON2));	//叹号
	//else hIcon=LoadIcon(GetModuleHandle(SHARE_CONTROL_DLL_NAME),MAKEINTRESOURCE(IDI_ICON4));	//星号
