...
CSkinTabCtrl::CSkinTabCtrl()
{
	...
	//设置变量
	m_crBackGround=RGB(196,219,231);
...
VOID CSkinTabCtrl::OnPaint()
{
	...
	for (INT i=0;i<GetItemCount();i++)
	{
		...
		dc.FillSolidRect(&rcItem,RGB(196,219,231));

		if(i!=GetCurSel()) dc.FillSolidRect(rcItem.left+1,rcItem.top+1,rcItem.Width()-1,rcItem.Height()-1,RGB(221,244,255));
		//else dc.FillSolidRect(&rcItem,RGB(255,255,255));
		else  dc.FillSolidRect(rcItem.left+1,rcItem.top+1,rcItem.Width()-1,rcItem.Height()-1,RGB(255,255,255));
