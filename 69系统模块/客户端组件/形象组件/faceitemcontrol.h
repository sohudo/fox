...
protected:
	...
	CPngImage						m_ImageBigFace;
	CPngImage						m_ImageSmallFace;
	CPngImage						m_ImageTableFace;
...
public:
	//绘制头像
	virtual VOID DrawFaceBigNormal(CDC * pDC, INT nXPos, INT nYPos,WORD wGender);
	//绘制头像
	virtual VOID DrawFaceSmallNormal(CDC * pDC, INT nXPos, INT nYPos,WORD wGender);
	//绘制头像
	//virtual	VOID DrawFaceTableNormal(CDC * pDC, INT nXPos, INT nYPos,WORD wGender, WORD wFaceID);
	virtual	VOID DrawFaceTableNormal(CDC * pDC, INT nXPos, INT nYPos,BYTE cbGender, WORD wFaceID);
};
