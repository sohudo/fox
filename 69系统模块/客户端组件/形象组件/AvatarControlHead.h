...
public:
	//绘制头像
	virtual VOID DrawFaceBigNormal(CDC * pDC, INT nXPos, INT nYPos,WORD wGender)=NULL;
	//绘制头像
	virtual VOID DrawFaceSmallNormal(CDC * pDC, INT nXPos, INT nYPos,WORD wGender)=NULL;
	//绘制头像
	//virtual	VOID DrawFaceTableNormal(CDC * pDC, INT nXPos, INT nYPos, WORD wGender, WORD wFaceID)=NULL;
	virtual	VOID DrawFaceTableNormal(CDC * pDC, INT nXPos, INT nYPos, BYTE cbGender, WORD wFaceID)=NULL;
};
