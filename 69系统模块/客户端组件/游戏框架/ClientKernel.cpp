			...
			for (BYTE i=0;i<pColumnInfo->cbColumnCount;i++)
			{
				...
				if (i==1)
					...
					if (cbColumnCount<CountArray(ColumnItem))
					{
						...
						ColumnItem[cbIndex].cbColumnWidth=60;
						ColumnItem[cbIndex].cbDataDescribe=UD_TABLE_GRADE;
						lstrcpyn(ColumnItem[cbIndex].szColumnName,TEXT("总成绩"),CountArray(ColumnItem[cbIndex].szColumnName));
					}
