...
VOID CDlgBuyProperty::UpdateCtrlStatus()
{
	...
	_sntprintf(szPropertyGold,CountArray(szPropertyGold),TEXT("%I64d 银子/%s （会员折扣：%ld%%）"),pPropertyInfo->lPropertyGold,pPropertyAttrib->szMeasuringunit,pPropertyInfo->wDiscount);
