...
BOOL CDlgEnquire::OnInitDialog()
{
	...
	m_btClosePlaza.SetWindowPos(NULL,nButtonSpace*3+rcButton.Width()*2,78+14,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	m_btCloseServer.SetWindowPos(NULL,nButtonSpace*2+rcButton.Width()*1,78+14,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	m_btSwitchAccounts.SetWindowPos(NULL,nButtonSpace*1+rcButton.Width()*0,78+14,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
