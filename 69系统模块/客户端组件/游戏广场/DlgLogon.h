...
protected:
	...
	CSkinButton						m_btDeleteRecord1;						//删除按钮
...
protected:
	...
	CSkinButton						m_btRem_Password;					//记住密码
	//CSkinButton						m_btRem_Password2;					//记住密码

	//特殊控件
protected:
	CSkinTabCtrl					m_TabControl;						//登录模式
	CServerControl					m_ServerControl;					//登录地址
	CPasswordControlEx				m_PasswordControl;					//用户密码
