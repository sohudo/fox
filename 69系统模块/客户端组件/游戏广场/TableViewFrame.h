...
public:
	...
	{
		ZeroMemory(m_szServerName,CountArray(m_szServerName));
		if(lpszName!=NULL) 	lstrcpy(m_szServerName,lpszName);	
	}
...
public:
	...
	//获取等级
	virtual WORD GetUserLevel(IClientUserItem * pIClientUserItem);
