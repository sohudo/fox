...
BOOL CDlgServicePassword::OnEraseBkgnd(CDC * pDC)
{
	...
	////绘画等级
	//ImagePassword.DrawImage(pBufferDC,230+20,76,SizePassword.cx*3,SizePassword.cy,0,0);
	//ImagePassword.DrawImage(pBufferDC,230+20,256,SizePassword.cx*3,SizePassword.cy,0,0);

	////绘画叠加
	//if (m_cbLogonPasswordLevel>=PASSWORD_LEVEL_1)
	//{
	//	INT nImagePos=(m_cbLogonPasswordLevel-PASSWORD_LEVEL_1)*SizePassword.cx;
	//	ImagePassword.DrawImage(pBufferDC,230+20+nImagePos,76,SizePassword.cx,SizePassword.cy,nImagePos,SizePassword.cy);
	//}
	...
	//	ImagePassword.DrawImage(pBufferDC,230+20+nImagePos,256,SizePassword.cx,SizePassword.cy,nImagePos,SizePassword.cy);
	//}
