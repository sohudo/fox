...
#define START_MODE_TIME_UNFULL_CONTROL		0x20						//时间控制且人数限制
//分组选项
...
//游戏时间
#define TIME_TABLE_SINK_RANGE		50//20									//标识范围
#define TIME_TABLE_KERNEL_RANGE		80//30									//标识范围
#define TIME_TABLE_MODULE_RANGE		100//50									//标识范围
