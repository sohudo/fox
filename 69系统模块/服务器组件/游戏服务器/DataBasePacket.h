...
//银行事件
#define DBR_GR_USER_SAVE_SCORE		400									//存入欢乐豆
#define DBR_GR_USER_TAKE_SCORE		401									//提取欢乐豆
#define DBR_GR_USER_TRANSFER_SCORE	402									//转账欢乐豆
#define DBR_GR_QUERY_INSURE_INFO	403									//查询银行
#define DBR_GR_QUERY_TRANSFER_USER_INFO	    404							//查询用户
#define DBR_GR_QUERY_BANK_DETAIL	407									//查询记录
...
#define DBO_GR_BANK_DETAIL_RESULT		306								//查询记录
...
struct DBO_GR_BankDetailResult
{
	BYTE							cbState;
