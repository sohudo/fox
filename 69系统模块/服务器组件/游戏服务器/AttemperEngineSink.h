...
//////////////////////////////////////////////////////////////////////////////////
	unsigned int                    Table;                              //桌子数目
	unsigned int                    Chair;                              //椅子数目
	BYTE                            StartMode;                          //开始模式
	unsigned int                    DistributingRobot[MAX_TABLE];       //分配机器
	unsigned int                    Active;                             //主动
	unsigned int                    Passive;                            //被动
	unsigned int                    Reciprocal;                         //相互
//////////////////////////////////////////////////////////////////////////////////
	//绑定信息
protected:
...
protected:
	...
	//查询记录
	bool OnTCPNetworkSubQueryInsureRecord(VOID * pData, WORD wDataSize, DWORD dwSocketID);
