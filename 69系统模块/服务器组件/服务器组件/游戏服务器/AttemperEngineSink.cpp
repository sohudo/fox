...
#define IDI_ON_ANDROID_SEND_TRUMPT  12
...
bool CAttemperEngineSink::OnAttemperEngineStart(IUnknownEx * pIUnknownEx)
{
	...
	WORD wKindID=m_pGameServiceAttrib->wKindID;
	switch (wKindID)
	{
	case 2:	//二人牛牛
	case 305:	//二人梭哈
	...
	case 33:	//四三公
		{
			m_pITimerEngine->SetTimer(IDI_LOAD_ANDROID_USER,TIME_LOAD_ANDROID_USER*220L, TIMES_INFINITY,NULL);
	...
	case 106:	//百人游戏
		{
			m_pITimerEngine->SetTimer(IDI_LOAD_ANDROID_USER,TIME_LOAD_ANDROID_USER*500L,TIMES_INFINITY,NULL);
					...
					if (bAllowAndroidAttend==true)
					{
						...
						else
						{
							...
							if (AndroidInitiative.wFreeUserCount>0)
							{
								...
								{
									//获取桌子
									CTableFrame * pTableFrame=m_TableFrameArray[i%wTempTableCount];
									if ((pTableFrame->IsGameStarted()==true)&&(bAllowDynamicJoin==false)) continue;
