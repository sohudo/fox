...
#define SUB_GR_CHECK_INSURE_PASSWORD	6								//校验密码
#define SUB_GR_CHANGE_INSURE_PASSWORD	7								//修改密码
#define SUB_GR_QUERY_BANK_DETAIL		8								//查询记录
...
#define SUB_GR_BANK_DETAIL_RESULT	106									//银行记录
...
//明细结果
struct CMD_GR_BankDetailResult
{
	BYTE							cbState;
