...
#define SUB_GP_REGISTER_CHECK	    4									//检测账号
...
#define SUB_GP_NEED_EXTERN			104									//额外信息
#define SUB_GP_REGISTER_CHECKRESULT 105                                 //注册检查结果
...
#define SUB_GP_USER_RECHARGE		104									//用户充值
//修改头像
...
#define SUB_GP_CHANGE_INSURE_PASSWORD	409								//修改密码

#define SUB_GP_QUERY_BANK_DETAIL		410								//交易记录
#define SUB_GP_BANK_DETAIL_RESULT		411								//交易记录

#define SUB_GP_USER_INSURE_LOGON    412                                 //用户登录
#define SUB_GP_USER_INSURE_LOGON_SUCCESS    413 
#define SUB_GP_USER_INSURE_LOGON_FAILURE    414  
...
//登录银行
struct CMD_GP_UserInsureLogonFailure
{
	LONG							lResultCode;						//错误代码
	TCHAR							szDescribeString[128];				//描述消息
};
